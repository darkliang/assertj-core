...
/**
 * Tests for <code>{@link ByteAssert#isEven()}</code>.
 *
 * @author Cal027
 */
// CS304 (manually written) Issue link: https://github.com/joel-costigliola/assertj-core/issues/1807
public class ByteAssert_isEven_Test extends ByteAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(bytes).assertIsEven(getInfo(assertions), getActual(assertions));
  }
}
